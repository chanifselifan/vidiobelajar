...
const SemuaProduk = () => {
  ...
  // Data kategori
  const categories = [
    { id: 'bidang-studi', name: 'Bidang Studi', items: [
      'Pemasaran',
      'Digital & Teknologi',
      'Pengembangan Diri',
      'Bisnis Manajemen'
    ]},
    { id: 'harga', name: 'Harga', items: [
      'Pemasaran',
      'Digital & Teknologi',
      'Pengembangan Diri',
      'Bisnis Manajemen'
    ]},
    { id: 'durasi', name: 'Durasi', items: [
      'Kurang dari 4 Jam',
      '4 - 8 Jam',
      'Lebih dari 8 Jam'
    ]}
              ...
              {[1, 2, 3, 4, 5, 6].map((page) => (
                <button
                  ...
                  className={`px-3 py-1 rounded-lg ${
                    page === 1 ? 'bg-orange-500 text-white' : 'hover:bg-gray-50'
                  }`}
                >
                  {page}
                </button>
