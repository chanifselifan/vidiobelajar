...
const Congrats = () => {
    ...
    useEffect(() => {
        localStorage.setItem('certificateAvailable', 'true');
    }, []);
        ...
        <div className='container py-2.5 px-4 sm:px-6 lg:px-8 overflow-y-auto'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="col-span-2">
                    <img src="/img/Congrats.png" alt="Congrats" className='w-full' />
                    <div className="max-w-2xl py-10 p-4">
                        ...
                        <div className="border-2 p-4 mb-2">
                            <div className="grid grid-cols-4 gap-4">
                                ...
                                <div className="text-center p-4">
                                    ...
                                    <p className="text-3xl text-green-500"><i className="fas fa-check-circle"></i> {score / 10}</p>
                                </div>
                                <div className="text-center p-4">
                                    <p className="font-bold">Salah</p>
                                    <p className="text-3xl text-red-500"><i className="fas fa-times-circle"></i> {10 - (score / 10)}</p>
                                </div>
                            </div>
                        </div>
                        <div className="border-b-2 pb-4 mb-4">
                            <h2 className="text-xl font-bold">Selamat!</h2>
                            <p className="text-gray-600">Kamu telah berhasil menyelesaikan quiz dengan nilai sempurna!</p>
                            <p className="text-gray-600">Silakan lanjutkan ke materi berikutnya.</p>
                        </div>
                        <div className="text-center">
                            ...
                            >
                                <i className="fas fa-arrow-right"></i> Lanjutkan
                            </button>
                        </div>
                    </div>
                </div>
